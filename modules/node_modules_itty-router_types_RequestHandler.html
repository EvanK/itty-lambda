...
<li><a href="" aria-current="page">node_modules/itty-router/types/RequestHandler</a></li></ul>
<h1>Module node_modules/itty-router/types/RequestHandler</h1></div>
...
<h2 class="tsd-anchor-link" id="type-aliases">Type Aliases<a href="#type-aliases" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h2></summary><dl class="tsd-member-summaries"><dt class="tsd-member-summary tsd-is-external" id="requesthandler"><span class="tsd-member-summary-name"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Type Alias"><use href="../assets/icons.svg#icon-2097152"></use></svg><a href="../types/node_modules_itty-router_types_RequestHandler.RequestHandler.html">RequestHandler</a><a href="#requesthandler" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></span></dt><dd class="tsd-member-summary tsd-is-external"></dd></dl></details></div>
...
<div><a href="#requesthandler" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Type Alias"><use href="../assets/icons.svg#icon-2097152"></use></svg><span>Request<wbr/>Handler</span></a></div></details></div></details></div>
<div class="site-menu">
