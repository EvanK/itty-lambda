...
<li><a href="" aria-current="page">CloudFrontRequestCallback</a></li></ul>
<h1>Type Alias CloudFrontRequestCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CloudFrontRequestCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Callback.html" class="tsd-signature-type tsd-kind-type-alias">Callback</a><span class="tsd-signature-symbol">&lt;</span><a href="node_modules__types_aws-lambda.CloudFrontRequestResult.html" class="tsd-signature-type tsd-kind-type-alias">CloudFrontRequestResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudfront-request.d.ts:5</li></ul></aside></div>
