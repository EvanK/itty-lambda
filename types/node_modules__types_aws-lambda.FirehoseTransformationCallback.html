...
<li><a href="" aria-current="page">FirehoseTransformationCallback</a></li></ul>
<h1>Type Alias FirehoseTransformationCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">FirehoseTransformationCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Callback.html" class="tsd-signature-type tsd-kind-type-alias">Callback</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.FirehoseTransformationResult.html" class="tsd-signature-type tsd-kind-interface">FirehoseTransformationResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/kinesis-firehose-transformation.d.ts:4</li></ul></aside></div>
