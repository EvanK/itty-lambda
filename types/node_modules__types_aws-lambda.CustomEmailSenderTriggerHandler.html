...
<li><a href="" aria-current="page">CustomEmailSenderTriggerHandler</a></li></ul>
<h1>Type Alias CustomEmailSenderTriggerHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CustomEmailSenderTriggerHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="node_modules__types_aws-lambda.CustomEmailSenderTriggerEvent.html" class="tsd-signature-type tsd-kind-type-alias">CustomEmailSenderTriggerEvent</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/custom-email-sender.d.ts:81</li></ul></aside></div>
