...
<li><a href="" aria-current="page">ProxyHandler</a></li></ul>
<h1>Type Alias ProxyHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">ProxyHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.APIGatewayProxyHandler.html" class="tsd-signature-type tsd-kind-type-alias">APIGatewayProxyHandler</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-proxy.d.ts:333</li></ul></aside></div>
