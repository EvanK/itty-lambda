...
<li><a href="" aria-current="page">CustomAuthorizerResult</a></li></ul>
<h1>Type Alias CustomAuthorizerResult</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CustomAuthorizerResult</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.APIGatewayAuthorizerResult.html" class="tsd-signature-type tsd-kind-interface">APIGatewayAuthorizerResult</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-authorizer.d.ts:188</li></ul></aside></div>
