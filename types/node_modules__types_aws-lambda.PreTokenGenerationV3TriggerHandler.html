...
<li><a href="" aria-current="page">PreTokenGenerationV3TriggerHandler</a></li></ul>
<h1>Type Alias PreTokenGenerationV3TriggerHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">PreTokenGenerationV3TriggerHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="node_modules__types_aws-lambda.PreTokenGenerationV3TriggerEvent.html" class="tsd-signature-type tsd-kind-type-alias">PreTokenGenerationV3TriggerEvent</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/pre-token-generation-v3.d.ts:50</li></ul></aside></div>
