...
<li><a href="" aria-current="page">PreTokenGenerationV3TriggerEvent</a></li></ul>
<h1>Type Alias PreTokenGenerationV3TriggerEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">PreTokenGenerationV3TriggerEvent</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.PreTokenGenerationClientCredentialsV3TriggerEvent.html" class="tsd-signature-type tsd-kind-type-alias">PreTokenGenerationClientCredentialsV3TriggerEvent</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/pre-token-generation-v3.d.ts:48</li></ul></aside></div>
