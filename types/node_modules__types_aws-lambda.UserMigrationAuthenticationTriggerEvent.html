...
<li><a href="" aria-current="page">UserMigrationAuthenticationTriggerEvent</a></li></ul>
<h1>Type Alias UserMigrationAuthenticationTriggerEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">UserMigrationAuthenticationTriggerEvent</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.BaseUserMigrationTriggerEvent.html" class="tsd-signature-type tsd-kind-interface">BaseUserMigrationTriggerEvent</a><span class="tsd-signature-symbol">&lt;</span><br/>    <span class="tsd-signature-type">&quot;UserMigration_Authentication&quot;</span><span class="tsd-signature-symbol">,</span><br/><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/user-migration.d.ts:29</li></ul></aside></div>
