...
<li><a href="" aria-current="page">AuthResponse</a></li></ul>
<h1>Type Alias AuthResponse</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">AuthResponse</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.APIGatewayAuthorizerResult.html" class="tsd-signature-type tsd-kind-interface">APIGatewayAuthorizerResult</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-authorizer.d.ts:189</li></ul></aside></div>
