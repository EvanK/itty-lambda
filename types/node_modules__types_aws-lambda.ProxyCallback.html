...
<li><a href="" aria-current="page">ProxyCallback</a></li></ul>
<h1>Type Alias ProxyCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">ProxyCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.APIGatewayProxyCallback.html" class="tsd-signature-type tsd-kind-type-alias">APIGatewayProxyCallback</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-proxy.d.ts:334</li></ul></aside></div>
