...
<li><a href="" aria-current="page">LexHandler</a></li></ul>
<h1>Type Alias LexHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">LexHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.LexEvent.html" class="tsd-signature-type tsd-kind-interface">LexEvent</a><span class="tsd-signature-symbol">,</span> <a href="../interfaces/node_modules__types_aws-lambda.LexResult.html" class="tsd-signature-type tsd-kind-interface">LexResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lex.d.ts:3</li></ul></aside></div>
