...
<li><a href="" aria-current="page">APIGatewayAuthorizerCallback</a></li></ul>
<h1>Type Alias APIGatewayAuthorizerCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">APIGatewayAuthorizerCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Callback.html" class="tsd-signature-type tsd-kind-type-alias">Callback</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.APIGatewayAuthorizerResult.html" class="tsd-signature-type tsd-kind-interface">APIGatewayAuthorizerResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-authorizer.d.ts:13</li></ul></aside></div>
