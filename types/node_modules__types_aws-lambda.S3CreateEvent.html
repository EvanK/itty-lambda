...
<li><a href="" aria-current="page">S3CreateEvent</a></li></ul>
<h1>Type Alias S3CreateEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">S3CreateEvent</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.S3Event.html" class="tsd-signature-type tsd-kind-interface">S3Event</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/s3.d.ts:60</li></ul></aside></div>
