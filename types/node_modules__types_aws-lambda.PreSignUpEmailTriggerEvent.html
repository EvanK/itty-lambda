...
<li><a href="" aria-current="page">PreSignUpEmailTriggerEvent</a></li></ul>
<h1>Type Alias PreSignUpEmailTriggerEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">PreSignUpEmailTriggerEvent</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.BasePreSignUpTriggerEvent.html" class="tsd-signature-type tsd-kind-interface">BasePreSignUpTriggerEvent</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">&quot;PreSignUp_SignUp&quot;</span><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/pre-signup.d.ts:17</li></ul></aside></div>
