...
<li><a href="" aria-current="page">CustomAuthorizerCallback</a></li></ul>
<h1>Type Alias CustomAuthorizerCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CustomAuthorizerCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.APIGatewayAuthorizerCallback.html" class="tsd-signature-type tsd-kind-type-alias">APIGatewayAuthorizerCallback</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-authorizer.d.ts:167</li></ul></aside></div>
