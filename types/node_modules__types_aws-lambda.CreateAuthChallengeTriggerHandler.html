...
<li><a href="" aria-current="page">CreateAuthChallengeTriggerHandler</a></li></ul>
<h1>Type Alias CreateAuthChallengeTriggerHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CreateAuthChallengeTriggerHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.CreateAuthChallengeTriggerEvent.html" class="tsd-signature-type tsd-kind-interface">CreateAuthChallengeTriggerEvent</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/create-auth-challenge.d.ts:22</li></ul></aside></div>
