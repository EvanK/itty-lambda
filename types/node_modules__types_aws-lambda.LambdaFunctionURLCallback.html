...
<li><a href="" aria-current="page">LambdaFunctionURLCallback</a></li></ul>
<h1>Type Alias LambdaFunctionURLCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">LambdaFunctionURLCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.APIGatewayProxyCallbackV2.html" class="tsd-signature-type tsd-kind-type-alias">APIGatewayProxyCallbackV2</a></div>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lambda-function-url.d.ts:26</li></ul></aside></div>
