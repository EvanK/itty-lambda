...
<li><a href="" aria-current="page">PreAuthenticationTriggerHandler</a></li></ul>
<h1>Type Alias PreAuthenticationTriggerHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">PreAuthenticationTriggerHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.PreAuthenticationTriggerEvent.html" class="tsd-signature-type tsd-kind-interface">PreAuthenticationTriggerEvent</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/pre-authentication.d.ts:16</li></ul></aside></div>
