...
<li><a href="" aria-current="page">CognitoUserPoolEvent</a></li></ul>
<h1 class="deprecated">Type Alias CognitoUserPoolEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CognitoUserPoolEvent</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.CognitoUserPoolTriggerEvent.html" class="tsd-signature-type tsd-kind-interface">CognitoUserPoolTriggerEvent</a></div>
<div class="tsd-comment tsd-typography">
<div class="tsd-tag-deprecated">
<h4 class="tsd-anchor-link" id="deprecated">Deprecated<a href="#deprecated" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h4><p>Please use specific event types instead</p>
</div></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/index.d.ts:111</li></ul></aside></div>
