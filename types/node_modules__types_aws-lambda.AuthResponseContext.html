...
<li><a href="" aria-current="page">AuthResponseContext</a></li></ul>
<h1>Type Alias AuthResponseContext</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">AuthResponseContext</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.APIGatewayAuthorizerResultContext.html" class="tsd-signature-type tsd-kind-interface">APIGatewayAuthorizerResultContext</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-authorizer.d.ts:190</li></ul></aside></div>
