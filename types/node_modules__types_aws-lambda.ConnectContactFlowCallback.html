...
<li><a href="" aria-current="page">ConnectContactFlowCallback</a></li></ul>
<h1>Type Alias ConnectContactFlowCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">ConnectContactFlowCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Callback.html" class="tsd-signature-type tsd-kind-type-alias">Callback</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.ConnectContactFlowResult.html" class="tsd-signature-type tsd-kind-interface">ConnectContactFlowResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/connect-contact-flow.d.ts:4</li></ul></aside></div>
