...
<li><a href="" aria-current="page">CloudFrontResponseCallback</a></li></ul>
<h1>Type Alias CloudFrontResponseCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CloudFrontResponseCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Callback.html" class="tsd-signature-type tsd-kind-type-alias">Callback</a><span class="tsd-signature-symbol">&lt;</span><a href="node_modules__types_aws-lambda.CloudFrontResponseResult.html" class="tsd-signature-type tsd-kind-type-alias">CloudFrontResponseResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudfront-response.d.ts:5</li></ul></aside></div>
