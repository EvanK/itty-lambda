...
<li><a href="" aria-current="page">APIGatewayAuthorizerEvent</a></li></ul>
<h1>Type Alias APIGatewayAuthorizerEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">APIGatewayAuthorizerEvent</span><span class="tsd-signature-symbol">:</span><br/>    <span class="tsd-signature-symbol">|</span> <a href="../interfaces/node_modules__types_aws-lambda.APIGatewayTokenAuthorizerEvent.html" class="tsd-signature-type tsd-kind-interface">APIGatewayTokenAuthorizerEvent</a><br/>    <span class="tsd-signature-symbol">|</span> <a href="../interfaces/node_modules__types_aws-lambda.APIGatewayRequestAuthorizerEvent.html" class="tsd-signature-type tsd-kind-interface">APIGatewayRequestAuthorizerEvent</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-authorizer.d.ts:26</li></ul></aside></div>
