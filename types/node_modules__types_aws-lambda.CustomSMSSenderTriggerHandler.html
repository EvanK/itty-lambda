...
<li><a href="" aria-current="page">CustomSMSSenderTriggerHandler</a></li></ul>
<h1>Type Alias CustomSMSSenderTriggerHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CustomSMSSenderTriggerHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="node_modules__types_aws-lambda.CustomSMSSenderTriggerEvent.html" class="tsd-signature-type tsd-kind-type-alias">CustomSMSSenderTriggerEvent</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/custom-sms-sender.d.ts:51</li></ul></aside></div>
