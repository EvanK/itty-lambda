...
<li><a href="" aria-current="page">S3BatchCallback</a></li></ul>
<h1>Type Alias S3BatchCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">S3BatchCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Callback.html" class="tsd-signature-type tsd-kind-type-alias">Callback</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.S3BatchResult.html" class="tsd-signature-type tsd-kind-interface">S3BatchResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/s3-batch.d.ts:8</li></ul></aside></div>
