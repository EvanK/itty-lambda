...
<li><a href="" aria-current="page">APIGatewayEvent</a></li></ul>
<h1>Type Alias APIGatewayEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">APIGatewayEvent</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.APIGatewayProxyEvent.html" class="tsd-signature-type tsd-kind-type-alias">APIGatewayProxyEvent</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-proxy.d.ts:335</li></ul></aside></div>
