...
<li><a href="" aria-current="page">PostAuthenticationTriggerHandler</a></li></ul>
<h1>Type Alias PostAuthenticationTriggerHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">PostAuthenticationTriggerHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.PostAuthenticationTriggerEvent.html" class="tsd-signature-type tsd-kind-interface">PostAuthenticationTriggerEvent</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/post-authentication.d.ts:15</li></ul></aside></div>
