...
<li><a href="" aria-current="page">GuardDutyNotificationEvent</a></li></ul>
<h1>Type Alias GuardDutyNotificationEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">GuardDutyNotificationEvent</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.GuardDutyScanResultNotificationEvent.html" class="tsd-signature-type tsd-kind-interface">GuardDutyScanResultNotificationEvent</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/guard-duty-event-notification.d.ts:36</li></ul></aside></div>
