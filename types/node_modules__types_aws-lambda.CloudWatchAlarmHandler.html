...
<li><a href="" aria-current="page">CloudWatchAlarmHandler</a></li></ul>
<h1>Type Alias CloudWatchAlarmHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">CloudWatchAlarmHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.CloudWatchAlarmEvent.html" class="tsd-signature-type tsd-kind-interface">CloudWatchAlarmEvent</a><span class="tsd-signature-symbol">,</span> <span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudwatch-alarm.d.ts:3</li></ul></aside></div>
