...
<li><a href="" aria-current="page">PreTokenGenerationHostedAuthTriggerEvent</a></li></ul>
<h1>Type Alias PreTokenGenerationHostedAuthTriggerEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">PreTokenGenerationHostedAuthTriggerEvent</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.BasePreTokenGenerationTriggerEvent.html" class="tsd-signature-type tsd-kind-interface">BasePreTokenGenerationTriggerEvent</a><span class="tsd-signature-symbol">&lt;</span><br/>    <span class="tsd-signature-type">&quot;TokenGeneration_HostedAuth&quot;</span><span class="tsd-signature-symbol">,</span><br/><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/pre-token-generation.d.ts:25</li></ul></aside></div>
