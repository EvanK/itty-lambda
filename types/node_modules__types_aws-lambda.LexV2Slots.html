...
<li><a href="" aria-current="page">LexV2Slots</a></li></ul>
<h1>Type Alias LexV2Slots</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">LexV2Slots</span><span class="tsd-signature-symbol">:</span> <a href="https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type" class="tsd-signature-type external" target="_blank">Record</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">,</span> <a href="node_modules__types_aws-lambda.LexV2Slot.html" class="tsd-signature-type tsd-kind-type-alias">LexV2Slot</a> <span class="tsd-signature-symbol">|</span> <span class="tsd-signature-type">null</span><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lex-v2.d.ts:138</li></ul></aside></div>
