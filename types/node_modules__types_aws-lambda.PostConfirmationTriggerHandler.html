...
<li><a href="" aria-current="page">PostConfirmationTriggerHandler</a></li></ul>
<h1>Type Alias PostConfirmationTriggerHandler</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">PostConfirmationTriggerHandler</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Handler.html" class="tsd-signature-type tsd-kind-type-alias">Handler</a><span class="tsd-signature-symbol">&lt;</span><a href="node_modules__types_aws-lambda.PostConfirmationTriggerEvent.html" class="tsd-signature-type tsd-kind-type-alias">PostConfirmationTriggerEvent</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cognito-user-pool-trigger/post-confirmation.d.ts:26</li></ul></aside></div>
