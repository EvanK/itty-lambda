...
<li><a href="" aria-current="page">ArtifactLocation</a></li></ul>
<h1>Type Alias ArtifactLocation</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">ArtifactLocation</span><span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_aws-lambda.S3ArtifactStore.html" class="tsd-signature-type tsd-kind-interface">S3ArtifactStore</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/codepipeline.d.ts:18</li></ul></aside></div>
