...
<li><a href="" aria-current="page">LambdaFunctionURLEvent</a></li></ul>
<h1>Type Alias LambdaFunctionURLEvent</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">LambdaFunctionURLEvent</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.APIGatewayProxyEventV2.html" class="tsd-signature-type tsd-kind-type-alias">APIGatewayProxyEventV2</a></div>
<div class="tsd-comment tsd-typography"><p>Default Lambda Function URL event with no Authorizer</p>
</div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lambda-function-url.d.ts:14</li></ul></aside></div>
