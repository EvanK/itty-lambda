...
<li><a href="" aria-current="page">AutoScalingScaleInCallback</a></li></ul>
<h1>Type Alias AutoScalingScaleInCallback</h1></div>
<div class="tsd-signature"><span class="tsd-kind-type-alias">AutoScalingScaleInCallback</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda_handler.Callback.html" class="tsd-signature-type tsd-kind-type-alias">Callback</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/node_modules__types_aws-lambda.AutoScalingScaleInResult.html" class="tsd-signature-type tsd-kind-interface">AutoScalingScaleInResult</a><span class="tsd-signature-symbol">&gt;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/autoscaling.d.ts:4</li></ul></aside></div>
