...
<li><a href="" aria-current="page">CloudWatchLogsEvent</a></li></ul>
<h1>Interface CloudWatchLogsEvent</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>See <a href="http://docs.aws.amazon.com/lambda/latest/dg/eventsources.html#eventsources-cloudwatch-logs">http://docs.aws.amazon.com/lambda/latest/dg/eventsources.html#eventsources-cloudwatch-logs</a></p>
</div></section>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">CloudWatchLogsEvent</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#awslogs">awslogs</a><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.CloudWatchLogsEventData.html" class="tsd-signature-type tsd-kind-interface">CloudWatchLogsEventData</a><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudwatch-logs.d.ts:8</li></ul></aside>
...
<div class="tsd-index-list"><a href="#awslogs" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>awslogs</span></a>
...
<h3 class="tsd-anchor-link" id="awslogs"><span>awslogs</span><a href="#awslogs" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">awslogs</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.CloudWatchLogsEventData.html" class="tsd-signature-type tsd-kind-interface">CloudWatchLogsEventData</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudwatch-logs.d.ts:9</li></ul></aside></section></section></details></div>
...
<div><a href="#awslogs" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>awslogs</span></a></div></details></div></details></div>
<div class="site-menu">
