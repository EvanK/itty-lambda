...
<div class="tsd-signature"><span class="tsd-kind-property">records</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.FirehoseTransformationResultRecord.html" class="tsd-signature-type tsd-kind-interface">FirehoseTransformationResultRecord</a><span class="tsd-signature-symbol">[]</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/kinesis-firehose-transformation.d.ts:50</li></ul></aside></section></section></details></div>
