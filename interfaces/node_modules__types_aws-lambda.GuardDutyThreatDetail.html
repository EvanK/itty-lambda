...
<li><a href="" aria-current="page">GuardDutyThreatDetail</a></li></ul>
<h1>Interface GuardDutyThreatDetail</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">GuardDutyThreatDetail</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#name">name</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/guard-duty-event-notification.d.ts:32</li></ul></aside>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/guard-duty-event-notification.d.ts:33</li></ul></aside></section></section></details></div>
...
<div><a href="#name" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>name</span></a></div></details></div></details></div>
<div class="site-menu">
