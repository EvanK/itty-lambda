...
<li><a href="" aria-current="page">LexV2ImageResponseCardButton</a></li></ul>
<h1>Interface LexV2ImageResponseCardButton</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">LexV2ImageResponseCardButton</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#text">text</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/>    <a class="tsd-kind-property" href="#value">value</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lex-v2.d.ts:132</li></ul></aside>
...
<div class="tsd-index-list"><a href="#text" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>text</span></a>
...
<h3 class="tsd-anchor-link" id="text"><span>text</span><a href="#text" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lex-v2.d.ts:133</li></ul></aside></section>
<section class="tsd-panel tsd-member tsd-is-external">
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lex-v2.d.ts:134</li></ul></aside></section></section></details></div>
