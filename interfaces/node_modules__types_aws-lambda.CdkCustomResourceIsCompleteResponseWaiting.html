...
<li><a href="" aria-current="page">CdkCustomResourceIsCompleteResponseWaiting</a></li></ul>
<h1>Interface CdkCustomResourceIsCompleteResponseWaiting</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>Response properties that are specifically for a still waiting <code>IsComplete</code> response for a CDK Custom Resource
...
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">CdkCustomResourceIsCompleteResponseWaiting</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#iscomplete">IsComplete</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">false</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cdk-custom-resource.d.ts:127</li></ul></aside>
...
<div class="tsd-index-list"><a href="#iscomplete" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Is<wbr/>Complete</span></a>
...
<div class="tsd-signature"><span class="tsd-kind-property">IsComplete</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">false</span></div>
<div class="tsd-comment tsd-typography"><p>Indicates the operation has not finished.</p>
</div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cdk-custom-resource.d.ts:131</li></ul></aside></section></section></details></div>
...
<div><a href="#iscomplete" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Is<wbr/>Complete</span></a></div></details></div></details></div>
<div class="site-menu">
