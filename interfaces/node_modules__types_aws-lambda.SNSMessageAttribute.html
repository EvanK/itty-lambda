...
<li><a href="" aria-current="page">SNSMessageAttribute</a></li></ul>
<h1>Interface SNSMessageAttribute</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">SNSMessageAttribute</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#type">Type</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/>    <a class="tsd-kind-property" href="#value">Value</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/sns.d.ts:6</li></ul></aside>
...
<div class="tsd-index-list"><a href="#type" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Type</span></a>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/sns.d.ts:7</li></ul></aside></section>
<section class="tsd-panel tsd-member tsd-is-external">
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/sns.d.ts:8</li></ul></aside></section></section></details></div>
