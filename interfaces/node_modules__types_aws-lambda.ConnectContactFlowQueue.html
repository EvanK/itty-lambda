...
<li><a href="" aria-current="page">ConnectContactFlowQueue</a></li></ul>
<h1>Interface ConnectContactFlowQueue</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">ConnectContactFlowQueue</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#arn">ARN</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/>    <a class="tsd-kind-property" href="#name">Name</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/connect-contact-flow.d.ts:41</li></ul></aside>
...
<div class="tsd-index-list"><a href="#arn" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>ARN</span></a>
...
<h3 class="tsd-anchor-link" id="arn"><span>ARN</span><a href="#arn" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">ARN</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/connect-contact-flow.d.ts:42</li></ul></aside></section>
<section class="tsd-panel tsd-member tsd-is-external">
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/connect-contact-flow.d.ts:43</li></ul></aside></section></section></details></div>
