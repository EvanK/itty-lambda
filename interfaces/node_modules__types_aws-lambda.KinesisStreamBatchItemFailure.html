...
<li><a href="" aria-current="page">KinesisStreamBatchItemFailure</a></li></ul>
<h1>Interface KinesisStreamBatchItemFailure</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">KinesisStreamBatchItemFailure</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#itemidentifier">itemIdentifier</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/kinesis-stream.d.ts:54</li></ul></aside>
...
<div class="tsd-index-list"><a href="#itemidentifier" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>item<wbr/>Identifier</span></a>
...
<h3 class="tsd-anchor-link" id="itemidentifier"><span>item<wbr/>Identifier</span><a href="#itemidentifier" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">itemIdentifier</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/kinesis-stream.d.ts:55</li></ul></aside></section></section></details></div>
...
<div><a href="#itemidentifier" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>item<wbr/>Identifier</span></a></div></details></div></details></div>
<div class="site-menu">
