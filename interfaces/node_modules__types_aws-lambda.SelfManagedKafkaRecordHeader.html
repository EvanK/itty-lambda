...
<li><a href="" aria-current="page">SelfManagedKafkaRecordHeader</a></li></ul>
<h1>Interface SelfManagedKafkaRecordHeader</h1></div>
<section class="tsd-panel">
<h4 class="tsd-before-signature">Indexable</h4>
<ul class="tsd-signatures">
<li class="tsd-index-signature tsd-is-external">
<div class="tsd-signature"><span class="tsd-signature-symbol">[</span><span class="tsd-kind-parameter">headerKey</span>: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]:</span> <span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">[]</span></div></li></ul></section><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/self-managed-kafka.d.ts:5</li></ul></aside></div>
