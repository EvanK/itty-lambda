...
<li><a href="" aria-current="page">S3EventRecordGlacierEventData</a></li></ul>
<h1>Interface S3EventRecordGlacierEventData</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">S3EventRecordGlacierEventData</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#restoreeventdata">restoreEventData</a><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.S3EventRecordGlacierRestoreEventData.html" class="tsd-signature-type tsd-kind-interface">S3EventRecordGlacierRestoreEventData</a><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/s3.d.ts:15</li></ul></aside>
...
<div class="tsd-index-list"><a href="#restoreeventdata" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>restore<wbr/>Event<wbr/>Data</span></a>
...
<h3 class="tsd-anchor-link" id="restoreeventdata"><span>restore<wbr/>Event<wbr/>Data</span><a href="#restoreeventdata" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">restoreEventData</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.S3EventRecordGlacierRestoreEventData.html" class="tsd-signature-type tsd-kind-interface">S3EventRecordGlacierRestoreEventData</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/s3.d.ts:16</li></ul></aside></section></section></details></div>
...
<div><a href="#restoreeventdata" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>restore<wbr/>Event<wbr/>Data</span></a></div></details></div></details></div>
<div class="site-menu">
