...
<li><a href="" aria-current="page">S3ArtifactStore</a></li></ul>
<h1>Interface S3ArtifactStore</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">S3ArtifactStore</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#s3location">s3Location</a><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.S3ArtifactLocation.html" class="tsd-signature-type tsd-kind-interface">S3ArtifactLocation</a><span class="tsd-signature-symbol">;</span><br/>    <a class="tsd-kind-property" href="#type">type</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">&quot;S3&quot;</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/codepipeline.d.ts:13</li></ul></aside>
...
<div class="tsd-index-list"><a href="#s3location" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>s3<wbr/>Location</span></a>
...
<h3 class="tsd-anchor-link" id="s3location"><span>s3<wbr/>Location</span><a href="#s3location" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">s3Location</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.S3ArtifactLocation.html" class="tsd-signature-type tsd-kind-interface">S3ArtifactLocation</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/codepipeline.d.ts:15</li></ul></aside></section>
<section class="tsd-panel tsd-member tsd-is-external">
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/codepipeline.d.ts:14</li></ul></aside></section></section></details></div>
