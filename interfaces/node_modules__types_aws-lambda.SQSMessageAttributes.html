...
<li><a href="" aria-current="page">SQSMessageAttributes</a></li></ul>
<h1>Interface SQSMessageAttributes</h1></div>
<section class="tsd-panel">
<h4 class="tsd-before-signature">Indexable</h4>
<ul class="tsd-signatures">
<li class="tsd-index-signature tsd-is-external">
<div class="tsd-signature"><span class="tsd-signature-symbol">[</span><span class="tsd-kind-parameter">name</span>: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]:</span> <a href="node_modules__types_aws-lambda.SQSMessageAttribute.html" class="tsd-signature-type tsd-kind-interface">SQSMessageAttribute</a></div></li></ul></section><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/sqs.d.ts:47</li></ul></aside></div>
