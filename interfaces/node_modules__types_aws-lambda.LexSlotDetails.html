...
<li><a href="" aria-current="page">LexSlotDetails</a></li></ul>
<h1>Interface LexSlotDetails</h1></div>
<section class="tsd-panel">
<h4 class="tsd-before-signature">Indexable</h4>
<ul class="tsd-signatures">
<li class="tsd-index-signature tsd-is-external">
<div class="tsd-signature"><span class="tsd-signature-symbol">[</span><span class="tsd-kind-parameter">name</span>: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]:</span> <a href="node_modules__types_aws-lambda.LexSlotDetail.html" class="tsd-signature-type tsd-kind-interface">LexSlotDetail</a></div></li></ul></section><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/lex.d.ts:51</li></ul></aside></div>
