...
<li><a href="" aria-current="page">AutoScalingScaleInResult</a></li></ul>
<h1>Interface AutoScalingScaleInResult</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">AutoScalingScaleInResult</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#instanceids">InstanceIDs</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/autoscaling.d.ts:39</li></ul></aside>
...
<div class="tsd-index-list"><a href="#instanceids" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Instance<wbr/>I<wbr/>Ds</span></a>
...
<h3 class="tsd-anchor-link" id="instanceids"><span>Instance<wbr/>I<wbr/>Ds</span><a href="#instanceids" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">InstanceIDs</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/autoscaling.d.ts:40</li></ul></aside></section></section></details></div>
...
<div><a href="#instanceids" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Instance<wbr/>I<wbr/>Ds</span></a></div></details></div></details></div>
<div class="site-menu">
