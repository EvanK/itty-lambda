...
<li><a href="" aria-current="page">APIGatewaySimpleAuthorizerResult</a></li></ul>
<h1>Interface APIGatewaySimpleAuthorizerResult</h1></div>
...
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">APIGatewaySimpleAuthorizerResult</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#isauthorized">isAuthorized</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div>
<section class="tsd-panel tsd-hierarchy" data-refl="618">
<h4>Hierarchy (<a href="../hierarchy.html#node_modules/@types/aws-lambda.APIGatewaySimpleAuthorizerResult">View Summary</a>)</h4>
<ul class="tsd-hierarchy">
<li class="tsd-hierarchy-item"><span class="tsd-hierarchy-target">APIGatewaySimpleAuthorizerResult</span>
<ul class="tsd-hierarchy">
<li class="tsd-hierarchy-item"><a href="node_modules__types_aws-lambda.APIGatewaySimpleAuthorizerWithContextResult.html" class="tsd-signature-type tsd-kind-interface">APIGatewaySimpleAuthorizerWithContextResult</a></li></ul></li></ul></section><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-authorizer.d.ts:141</li></ul></aside>
...
<div class="tsd-index-list"><a href="#isauthorized" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>is<wbr/>Authorized</span></a>
...
<div><a href="#isauthorized" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>is<wbr/>Authorized</span></a></div></details></div></details></div>
<div class="site-menu">
