...
<li><a href="" aria-current="page">DynamoDBBatchItemFailure</a></li></ul>
<h1>Interface DynamoDBBatchItemFailure</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">DynamoDBBatchItemFailure</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#itemidentifier">itemIdentifier</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/dynamodb-stream.d.ts:61</li></ul></aside>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/dynamodb-stream.d.ts:62</li></ul></aside></section></section></details></div>
