...
<li><a href="" aria-current="page">IoTProtocolDataTLS</a></li></ul>
<h1>Interface IoTProtocolDataTLS</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">IoTProtocolDataTLS</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#servername">serverName</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/iot-authorizer.d.ts:8</li></ul></aside>
...
<div class="tsd-index-list"><a href="#servername" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>server<wbr/>Name</span></a>
...
<h3 class="tsd-anchor-link" id="servername"><span>server<wbr/>Name</span><a href="#servername" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">serverName</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/iot-authorizer.d.ts:9</li></ul></aside></section></section></details></div>
...
<div><a href="#servername" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>server<wbr/>Name</span></a></div></details></div></details></div>
<div class="site-menu">
