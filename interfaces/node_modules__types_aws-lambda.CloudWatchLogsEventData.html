...
<li><a href="" aria-current="page">CloudWatchLogsEventData</a></li></ul>
<h1>Interface CloudWatchLogsEventData</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">CloudWatchLogsEventData</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#data">data</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudwatch-logs.d.ts:12</li></ul></aside>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudwatch-logs.d.ts:13</li></ul></aside></section></section></details></div>
...
<div><a href="#data" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>data</span></a></div></details></div></details></div>
<div class="site-menu">
