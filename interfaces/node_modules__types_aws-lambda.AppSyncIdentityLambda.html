...
<li><a href="" aria-current="page">AppSyncIdentityLambda</a></li></ul>
<h1>Interface AppSyncIdentityLambda</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">AppSyncIdentityLambda</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#resolvercontext">resolverContext</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/appsync-resolver.d.ts:119</li></ul></aside>
...
<div class="tsd-index-list"><a href="#resolvercontext" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>resolver<wbr/>Context</span></a>
...
<h3 class="tsd-anchor-link" id="resolvercontext"><span>resolver<wbr/>Context</span><a href="#resolvercontext" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">resolverContext</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/appsync-resolver.d.ts:120</li></ul></aside></section></section></details></div>
...
<div><a href="#resolvercontext" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>resolver<wbr/>Context</span></a></div></details></div></details></div>
<div class="site-menu">
