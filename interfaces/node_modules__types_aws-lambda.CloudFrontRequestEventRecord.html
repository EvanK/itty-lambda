...
<li><a href="" aria-current="page">CloudFrontRequestEventRecord</a></li></ul>
<h1>Interface CloudFrontRequestEventRecord</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">CloudFrontRequestEventRecord</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#cf">cf</a><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.CloudFrontEvent.html" class="tsd-signature-type tsd-kind-interface">CloudFrontEvent</a> <span class="tsd-signature-symbol">&amp;</span> <span class="tsd-signature-symbol">{</span> <span class="tsd-kind-property">request</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.CloudFrontRequest.html" class="tsd-signature-type tsd-kind-interface">CloudFrontRequest</a> <span class="tsd-signature-symbol">}</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudfront-request.d.ts:7</li></ul></aside>
...
<div class="tsd-signature"><span class="tsd-kind-property">cf</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.CloudFrontEvent.html" class="tsd-signature-type tsd-kind-interface">CloudFrontEvent</a> <span class="tsd-signature-symbol">&amp;</span> <span class="tsd-signature-symbol">{</span> <span class="tsd-kind-property">request</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.CloudFrontRequest.html" class="tsd-signature-type tsd-kind-interface">CloudFrontRequest</a> <span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/cloudfront-request.d.ts:8</li></ul></aside></section></section></details></div>
