...
<li><a href="" aria-current="page">KinesisStreamEvent</a></li></ul>
<h1>Interface KinesisStreamEvent</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">KinesisStreamEvent</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#records">Records</a><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.KinesisStreamRecord.html" class="tsd-signature-type tsd-kind-interface">KinesisStreamRecord</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div>
<section class="tsd-panel tsd-hierarchy" data-refl="2439">
<h4>Hierarchy (<a href="../hierarchy.html#node_modules/@types/aws-lambda.KinesisStreamEvent">View Summary</a>)</h4>
<ul class="tsd-hierarchy">
<li class="tsd-hierarchy-item"><span class="tsd-hierarchy-target">KinesisStreamEvent</span>
<ul class="tsd-hierarchy">
<li class="tsd-hierarchy-item"><a href="node_modules__types_aws-lambda.KinesisStreamTumblingWindowEvent.html" class="tsd-signature-type tsd-kind-interface">KinesisStreamTumblingWindowEvent</a></li></ul></li></ul></section><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/kinesis-stream.d.ts:33</li></ul></aside>
...
<div class="tsd-index-list"><a href="#records" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Records</span></a>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/kinesis-stream.d.ts:34</li></ul></aside></section></section></details></div>
...
<div><a href="#records" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Records</span></a></div></details></div></details></div>
<div class="site-menu">
