...
<li><a href="" aria-current="page">SESMailHeader</a></li></ul>
<h1>Interface SESMailHeader</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">SESMailHeader</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#name">name</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/>    <a class="tsd-kind-property" href="#value">value</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/ses.d.ts:6</li></ul></aside>
...
<div class="tsd-index-list"><a href="#name" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>name</span></a>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/ses.d.ts:7</li></ul></aside></section>
<section class="tsd-panel tsd-member tsd-is-external">
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/ses.d.ts:8</li></ul></aside></section></section></details></div>
