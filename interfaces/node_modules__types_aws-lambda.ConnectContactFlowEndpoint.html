...
<li><a href="" aria-current="page">ConnectContactFlowEndpoint</a></li></ul>
<h1>Interface ConnectContactFlowEndpoint</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">ConnectContactFlowEndpoint</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#address">Address</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">;</span><br/>    <a class="tsd-kind-property" href="#type">Type</a><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">&quot;TELEPHONE_NUMBER&quot;</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/connect-contact-flow.d.ts:36</li></ul></aside>
...
<div class="tsd-index-list"><a href="#address" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>Address</span></a>
...
<h3 class="tsd-anchor-link" id="address"><span>Address</span><a href="#address" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/connect-contact-flow.d.ts:37</li></ul></aside></section>
<section class="tsd-panel tsd-member tsd-is-external">
...
<div class="tsd-signature"><span class="tsd-kind-property">Type</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">&quot;TELEPHONE_NUMBER&quot;</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/connect-contact-flow.d.ts:38</li></ul></aside></section></section></details></div>
