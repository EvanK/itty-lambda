...
<li><a href="" aria-current="page">DynamoDBBatchResponse</a></li></ul>
<h1>Interface DynamoDBBatchResponse</h1></div>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">DynamoDBBatchResponse</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#batchitemfailures">batchItemFailures</a><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.DynamoDBBatchItemFailure.html" class="tsd-signature-type tsd-kind-interface">DynamoDBBatchItemFailure</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/dynamodb-stream.d.ts:57</li></ul></aside>
...
<div class="tsd-index-list"><a href="#batchitemfailures" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>batch<wbr/>Item<wbr/>Failures</span></a>
...
<h3 class="tsd-anchor-link" id="batchitemfailures"><span>batch<wbr/>Item<wbr/>Failures</span><a href="#batchitemfailures" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">batchItemFailures</span><span class="tsd-signature-symbol">:</span> <a href="node_modules__types_aws-lambda.DynamoDBBatchItemFailure.html" class="tsd-signature-type tsd-kind-interface">DynamoDBBatchItemFailure</a><span class="tsd-signature-symbol">[]</span></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/dynamodb-stream.d.ts:58</li></ul></aside></section></section></details></div>
...
<div><a href="#batchitemfailures" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>batch<wbr/>Item<wbr/>Failures</span></a></div></details></div></details></div>
<div class="site-menu">
