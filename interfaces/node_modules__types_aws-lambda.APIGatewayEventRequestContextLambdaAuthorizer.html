...
<li><a href="" aria-current="page">APIGatewayEventRequestContextLambdaAuthorizer</a></li></ul>
<h1>Interface APIGatewayEventRequestContextLambdaAuthorizer&lt;TAuthorizerContext&gt;</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>Lambda Authorizer Payload</p>
</div></section>
<div class="tsd-signature"><span class="tsd-signature-keyword">interface</span> <span class="tsd-kind-interface">APIGatewayEventRequestContextLambdaAuthorizer</span><span class="tsd-signature-symbol">&lt;</span><a class="tsd-signature-type tsd-kind-type-parameter" href="#tauthorizercontext">TAuthorizerContext</a><span class="tsd-signature-symbol">&gt;</span> <span class="tsd-signature-symbol">{</span><br/>    <a class="tsd-kind-property" href="#lambda">lambda</a><span class="tsd-signature-symbol">:</span> <a class="tsd-signature-type tsd-kind-type-parameter" href="#tauthorizercontext">TAuthorizerContext</a><span class="tsd-signature-symbol">;</span><br/><span class="tsd-signature-symbol">}</span></div>
...
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-proxy.d.ts:249</li></ul></aside>
...
<div class="tsd-index-list"><a href="#lambda" class="tsd-index-link tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>lambda</span></a>
...
<h3 class="tsd-anchor-link" id="lambda"><span>lambda</span><a href="#lambda" aria-label="Permalink" class="tsd-anchor-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="../assets/icons.svg#icon-anchor"></use></svg></a></h3>
<div class="tsd-signature"><span class="tsd-kind-property">lambda</span><span class="tsd-signature-symbol">:</span> <a class="tsd-signature-type tsd-kind-type-parameter" href="#tauthorizercontext">TAuthorizerContext</a></div><aside class="tsd-sources">
<ul>
<li>Defined in node_modules/@types/aws-lambda/trigger/api-gateway-proxy.d.ts:250</li></ul></aside></section></section></details></div>
...
<div><a href="#lambda" class="tsd-is-external"><svg class="tsd-kind-icon" viewBox="0 0 24 24" aria-label="Property"><use href="../assets/icons.svg#icon-1024"></use></svg><span>lambda</span></a></div></details></div></details></div>
<div class="site-menu">
